...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
        ...
        baseIntent = new Intent(Intent.ACTION_VIEW, website);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // Process the result only if this method received both a RESULT_OK result code
        // and a recognized request code. If so, update the Textview showing the user-entered text.
